...
parser.add_argument('output_file',
                    help='Output folder for the generated audio file. Use \'-\' on this arg, for make the generated audio to be played on-the-fly instead of generating an audio file')
...
parser.add_argument('gain', type=float, default=1,
                    help=f'Voice gain (0.0 = no sound, 1.0 = normal volume, 1.1 > higher than normal)')
...
parser.add_argument('speaker_boost', type=bool, default=True,
                    help=f'Use speaker boost (False (Faster) or True (Slower))')
